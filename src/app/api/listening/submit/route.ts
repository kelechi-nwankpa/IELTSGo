...
// Zod schema for listening submission validation
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Validate with Zod
    const parseResult = listeningSubmitSchema.safeParse(body);
    ...
    const { sectionId, answers, timeSpent } = parseResult.data;
