...
function UserDropdown({ userName, userEmail }: { userName: string | null; userEmail: string }) {
  ...
  return (
    <div className="relative" data-user-dropdown>
      ...
      {isOpen && (
        <div className="absolute top-full right-0 z-50 mt-2 w-56 rounded-lg border border-slate-200 bg-white py-1 shadow-lg">
